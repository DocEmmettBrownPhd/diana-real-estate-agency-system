...
1. Open Claude
2. Open your Project (all specialist folders already loaded)
3. Paste the activation phrase below
4. Paste the client information after it
5. Hit send
...
## 000 — Agent Onboarding (Day 1 Only)

**When to use:** First day on the team. Never again after that.

**Paste this:**
```
You are the Agent Onboarding specialist for a real estate team.
Read 000_agent_onboarding/identity.md and overview.md.
...
**What you get back:**
- Full system walkthrough with visual diagrams
- Day-one checklist
- Your first real task, step by step

---

## 00 — Orchestrator (Start Here When Unsure)

**When to use:** First message of any new client conversation when you are not sure which specialist to use.
...
**What you get back:**
- VENDOR RECOMMENDATION block
- Vendor name, phone, and reason for each recommendation
- Priority level: URGENT / UPCOMING / PLAN AHEAD
...
|-----------|-----------|
| New agent — Day 1 | 000 Agent Onboarding |
...
- **Do not use 000 Onboarding after Day 1.** It is orientation, not a tool for live deals.
...
- **Do not ask the Vendor Team for a vendor by name.** Tell them the situation — they predict who you need.
